...
namespace OvenLanding.Data
{
    public class DBQueries
    {
        ...
        private string _ingotsMyMeltQuery = "WITH t0 as" +
                                ...
                                "join mts.passport pm on pm.unit_id = r1.unit_id_parent and pm.param_id=10000001 and value_s ='{0}' " +
        ...
        private string _returningsByMelt =
        ...
        private string _returningsByPeriod =
            "with t0 as (select rp.unit_id_parent as id_posad, pr.value_s as prod, " +
            "l.tm_beg::timestamp as tm_beg, l.tm_end::timestamp as tm_end, " +
        ...
        public string GetIngotsMyMeltQuery(string melt)
        {
            return string.Format(_ingotsMyMeltQuery, melt);
        }
        ...
        public string GetReturnsByMelt(string melt)
        {
            return string.Format(_returningsByMelt, melt);
        }
        ...
        {
            return string.Format(_returningsByPeriod, begin, end);
        }
    }
}